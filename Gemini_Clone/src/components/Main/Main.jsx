        ...
        <div className="main-container">
            ...
            <div className="main-bottom">
                ...
                <p className="bottom-info">
                    Gemini may display inaccurate or misleading information and should not be relied upon as a sole source of truth. Always verify information from multiple sources before making decisions based on it.
                </p>
            </div>
        </div>
    </div>
